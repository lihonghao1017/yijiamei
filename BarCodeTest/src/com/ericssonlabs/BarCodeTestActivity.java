...
//						//根据字符串生成二维码图片并显示在界面上，第二个参数为图片的大小（350*350）
						...
						try {
							qrCodeBitmap = EncodingHandler.createQRCode(contentString, 900);
...
//						try {
//				            File filePic = new File( "/sdcard/haoge222.jpg");
//				            if (!filePic.exists()) {
...
//						
						...
						//条形码
//						Bitmap qrCodeBitmap = EncodingHandler.creatBarcode(BarCodeTestActivity.this,
